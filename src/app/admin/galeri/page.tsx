...
import { Plus, Trash2, Edit2, Image as ImageIcon, CheckCircle, Info, PlayCircle } from 'lucide-react';
      ...
      <div className="p-8 space-y-6">
        ...
        <div className="flex items-center justify-between">
          ...
          >
            ...
            <span>Yeni Görsel/Video Ekle</span>
          </button>
        </div>
                ...
                <div key={item.id} className="group relative bg-slate-50 rounded-2xl border border-slate-100/50 overflow-hidden transition-all hover:shadow-xl hover:border-blue-100">
                  <div className="aspect-[4/3] relative overflow-hidden bg-slate-900">
                    {item.mediaType === 'video' ? (
                      <video src={item.img} muted className="w-full h-full object-cover transition-transform duration-500 group-hover:scale-110" />
                    ) : (
