            ...
            <FadeIn direction="up" delay={0.1} className="lg:col-span-2 h-full">
              <div className="h-full bg-white border border-slate-100 rounded-3xl shadow-sm overflow-hidden flex flex-col">
                ...
                <div className="flex flex-col flex-1 divide-y divide-slate-100">
                  ...
                  <a href="https://wa.me/905321397799" target="_blank" rel="noopener noreferrer" className="group flex items-center gap-4 px-8 py-5 hover:bg-slate-50 transition-colors">
                  ...
                  <a href="mailto:nurullahermis@central.com.tr" className="group flex items-center gap-4 px-8 py-5 hover:bg-slate-50 transition-colors">
                    <div className="w-10 h-10 rounded-xl bg-blue-50 flex items-center justify-center shrink-0 group-hover:bg-blue-600 transition-colors">
                ...
                <div className="px-8 py-6 border-t border-slate-100">
                  <a href="https://wa.me/905321397799" target="_blank" rel="noopener noreferrer" className="flex items-center justify-center gap-2 w-full py-3.5 rounded-2xl bg-emerald-600 hover:bg-emerald-500 text-white text-sm font-bold transition-all shadow-md shadow-emerald-600/20">
