        ...
        <div className="flex h-9 w-max min-w-full items-center gap-4 whitespace-nowrap lg:w-auto lg:justify-between">
          ...
          <div className="flex shrink-0 items-center gap-3">
            <div className="flex items-center gap-1">
              <a href="https://www.instagram.com/prof.dr.nurullah.ermis/" target="_blank" rel="noopener noreferrer" className="p-1.5 transition-colors hover:text-blue-300">
              ...
              <a href="https://www.youtube.com/@centralhospitaltr" target="_blank" rel="noopener noreferrer" className="p-1.5 transition-colors hover:text-blue-300">
                <svg className="h-3.5 w-3.5" fill="currentColor" viewBox="0 0 24 24">
                  <path d="M23.498 6.186a3.016 3.016 0 0 0-2.122-2.136C19.505 3.545 12 3.545 12 3.545s-7.505 0-9.377.505A3.017 3.017 0 0 0 .502 6.186C0 8.07 0 12 0 12s0 3.93.502 5.814a3.016 3.016 0 0 0 2.122 2.136c1.871.505 9.376.505 9.376.505s7.505 0 9.377-.505a3.015 3.015 0 0 0 2.122-2.136C24 15.93 24 12 24 12s0-3.93-.502-5.814zM9.545 15.568V8.432L15.818 12l-6.273 3.568z" />
                </svg>
              </a>
              <a href="https://wa.me/905321397799" target="_blank" rel="noopener noreferrer" className="p-1.5 transition-colors hover:text-blue-300">
                <svg className="h-3.5 w-3.5" fill="currentColor" viewBox="0 0 24 24">
